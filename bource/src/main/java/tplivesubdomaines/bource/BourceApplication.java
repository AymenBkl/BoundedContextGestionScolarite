...
public class BourceApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v2));
        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v3));
        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v2));

        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v1));
        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v1));
        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v3));
        etudiantrepo.save(new Etudiant(null,456789L,2500f,true,v2));
