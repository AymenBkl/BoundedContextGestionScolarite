...
public class ScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        reporestconf.exposeIdsFor(Etudiant.class);
        ...
        etudiantrepo.save(new Etudiant(null,"aymen",Date.valueOf("2016-06-06"),"A",Date.valueOf("2017-09-05"),e1,1L,null,null));
        etudiantrepo.save(new Etudiant(null,"aymen2",Date.valueOf("2016-06-06"),"B",Date.valueOf("2017-09-05"),e2,2L,null,null));
        etudiantrepo.save(new Etudiant(null,"aymen3",Date.valueOf("2016-06-06"),"C",Date.valueOf("2017-09-05"),e3,1L,null,null));
        etudiantrepo.save(new Etudiant(null,"aymen4",Date.valueOf("2016-06-06"),"D",Date.valueOf("2017-09-05"),e1,2L,null,null));
